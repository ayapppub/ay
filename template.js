...
user_pref("network.proxy.backup.ftp_port", ?PROXYPORT?);
user_pref("network.proxy.backup.socks", "");
user_pref("network.proxy.backup.socks_port", ?PROXYPORT?);
user_pref("network.proxy.backup.ssl", "");
user_pref("network.proxy.backup.ssl_port", ?PROXYPORT?);
...
user_pref("geo.wifi.uri", "data:application/json,{\"location\": {\"lat\": ?GPSLAT?, \"lng\": ?GPSLONG?}, \"accuracy\": 27000.0}");
...
user_pref("geo.provider.network.url", "data:application/json,{\"location\": {\"lat\": ?GPSLAT?, \"lng\": ?GPSLONG?}, \"accuracy\": 27000.0}");
